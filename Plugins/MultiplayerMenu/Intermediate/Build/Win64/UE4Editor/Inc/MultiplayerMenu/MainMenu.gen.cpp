...
// Cross Module References
	MULTIPLAYERMENU_API UScriptStruct* Z_Construct_UScriptStruct_FServerData();
	UPackage* Z_Construct_UPackage__Script_MultiplayerMenu();
	MULTIPLAYERMENU_API UClass* Z_Construct_UClass_UMainMenu_NoRegister();
	MULTIPLAYERMENU_API UClass* Z_Construct_UClass_UMainMenu();
	MULTIPLAYERMENU_API UClass* Z_Construct_UClass_UMenuWidget();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_HostServer();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_JoinServer();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_OpenHostMenu();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_OpenJoinMenu();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_OpenMainMenu();
	MULTIPLAYERMENU_API UFunction* Z_Construct_UFunction_UMainMenu_QuitPressed();
...
class UScriptStruct* FServerData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MULTIPLAYERMENU_API uint32 Get_Z_Construct_UScriptStruct_FServerData_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FServerData, Z_Construct_UPackage__Script_MultiplayerMenu(), TEXT("ServerData"), sizeof(FServerData), Get_Z_Construct_UScriptStruct_FServerData_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FServerData(FServerData::StaticStruct, TEXT("/Script/MultiplayerMenu"), TEXT("ServerData"), false, nullptr, nullptr);
static struct FScriptStruct_MultiplayerMenu_StaticRegisterNativesFServerData
{
	FScriptStruct_MultiplayerMenu_StaticRegisterNativesFServerData()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("ServerData")),new UScriptStruct::TCppStructOps<FServerData>);
	}
} ScriptStruct_MultiplayerMenu_StaticRegisterNativesFServerData;
	UScriptStruct* Z_Construct_UScriptStruct_FServerData()
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FServerData_CRC();
		UPackage* Outer = Z_Construct_UPackage__Script_MultiplayerMenu();
	...
	uint32 Get_Z_Construct_UScriptStruct_FServerData_CRC() { return 3480016062U; }
	...
	IMPLEMENT_CLASS(UMainMenu, 2117192676);
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMainMenu(Z_Construct_UClass_UMainMenu, &UMainMenu::StaticClass, TEXT("/Script/MultiplayerMenu"), TEXT("UMainMenu"), false, nullptr, nullptr, nullptr);
